...
?>
<div class="text-center mt-2 text-uppercase" style=" color:rgba(4, 94, 233, 0.9); letter-spacing:0.1rem; text-shadow: 1.3px 2px 2px  rgba(4, 94, 233, 0.7)!important; font-size:25px;  font-family: Poppins-Regular;">SHEET: <?php echo $actualsheetname ; ?> </div>
<?php 
...
<colgroup>
  ...
  <tr class="fr bg-light text-dark" >
    <th style="font-size: 12px; padding:5px;">Valid:<span style="color: red; font-size:10px;">dd/mm/yyyy</span></th>
        ...
        <th class="text-end" style="background-color:rgba(4, 94, 233, 0.7);">CURRENT BALANCE=</th>
        
        <th style="background-color:rgba(4, 94, 233, 0.7);"><?php echo $sumup ?></th>
        <th colspan="3" style="font-size:10px!important;">Amount should have no decimal numbers or commas. All CREDITS (expenses) should start with - </th>
    ...
    <th  scope="col">DATE</th>
	  ...
	  <th class="bt1" scope="col"><button class="bt btn btn-flat bg-dark btn-primary my-1 " id="add_member" type="button" style="padding:1px!important;">Add</button></th>
    </tr>
...
<?php $arr = explode('-',trim($row['note']));
    ...
    <td class="bt1 text-center p-0" style="display:inline-flex;">
