	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="reg.php" method="POST" oninput='conpass.setCustomValidity(conpass.value != pass.value ? "Passwords do not match." : "")'>
...
?>
					...
					<div class="text-center p-t-115">
						...
						<a class="txt2"  href="login.php">Log In
						</a>
					</div>
