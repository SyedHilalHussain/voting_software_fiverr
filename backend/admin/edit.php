...
<tr>
      ...
      <tr>
      <td>Type <br>(1 for admin 0 for user -1 for viewer)</td>
      <td><input type="text" name="user_type" value="<?php echo $row['user_type']; ?>"></td>
      </tr>
      
   
      <tr>
      <th scope="col" colspan="2" class="py-1" style="font-size:23px ;"><button type='submit' name='edit_user' class='btn btn-first'>UPDATE</button></th>
