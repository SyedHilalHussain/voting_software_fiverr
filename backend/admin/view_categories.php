...
<body>
	...
	<div class="text-center my-1" style=" color:rgba(4, 94, 233, 0.9);  text-shadow: 1.3px 2px 2px rgba(4, 94, 233, 0.7)!important; font-size:30px;  font-family: Poppins-Regular;">View Categories</div>
						...
						<tbody>
							<form action="../config.php" method="post">
								...
								<tr>
									...
									<td><i class="h bi bi-pencil-square edit-category" data-bs-toggle="modal" data-category-id="<?php echo $row['category_id']; ?>" data-bs-target="#staticBackdrop3"></i></td>
									<td><a href="delete.php?category_id=<?php echo $row['category_id'] ?>"><i class="h bi bi-trash"></i></a></td>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<form class="login100-form validate-form" action="../config.php" method="POST">
					...
					<input type="hidden" name="category_id" id="modalCategoryId"  value="" class="form-control form-control-sm" id="floatingInput" placeholder="name@example.com">


					<div class="form-floating m-3">
						<input type="text" name="category" class="form-control form-control-sm" id="floatingInput" placeholder="name@example.com">
						<label for="floatingInput">Update Category</label>
					</div>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn w-50 my-2">
							...
							<button class="login100-form-btn" name="update_category">
								UPDATE
							</button>
						</div>
					</div>
