		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="../config.php" method="POST">
					<span class="login100-form-title mb-4" style="font-family:poppins-extralight;   font-weight:bolder; color:rgba(4, 94, 233, 0.9);">
						NED SCHOLARS
					</span>
...
$id=$_GET['id'];
?>
                                      <input class="input100" type="hidden" name="passid"     value="<?php echo $id;  ?>"  required>
<?php } ?>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" name="passchange">
								Change
							</button>
						</div>
					</div>
