...
<input type="hidden" name="user_id" class="form-control" value="<?php echo  $_SESSION['user_id']  ?>" id="floatingInput" placeholder="name@example.com">
...
<?php  }else{
 ...
 header("Location:../logout.php");
  ...
  <input type="text" name="problem" class="form-control" id="floatingInput" placeholder="name@example.com">
  ...
  <label for="floatingSelect">Community</label>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" name="add_problem">
								ADD
							</button>
						</div>
					</div>
