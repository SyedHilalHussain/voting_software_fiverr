    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        ?>
         ...
         <?php
          //  $sqlheader="SELECT name FROM billusers ";
          //  $resultheader= mysqli_query($conn,$sqlheader) or die("Query failed");
          //  if(mysqli_num_rows($resultheader)>0){

          ?>
          <ul class=" dropdown-menu  p-0 bg-dark mx-2 mt-1 text-center" aria-labelledby="navbarDropdown" style="min-width:130px!important; background-color: #04245c!important;">
          <?php
          //     while($rowheader=mysqli_fetch_assoc($resultheader)){
          //  echo  '<li><a class="n nav-link active dropdown-item " href="#"> '. $rowheader["name"] .' </a></li>';
          //   }
          ?> 
          </ul>
          <?php
          ...
          <div class="modal-content">
            ...
            <form action="config.php" method="post">
              ...
              <div class="modal-footer">
                <!-- <button type="button" class="bt btn btn-secondary" data-bs-dismiss="modal">Close</button> -->
